  ...
  return (
    <div className="min-h-screen bg-[#343541] text-white">
      ...
      <div className="flex items-center justify-between px-6 py-4 border-b border-gray-700 bg-[#202123]">
        ...
        <div className="flex items-center gap-3">
          <a href="/quiz" className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded-lg text-sm">
            🧠 Quiz Mode
          </a>
      ...
      <div className="max-w-3xl mx-auto px-4 py-8">
        ...
        <div className="bg-[#40414f] rounded-2xl p-6 mb-8 space-y-4">
          <p className="text-sm text-gray-400">Generate practice questions from your uploaded document.</p>

          <div className="flex gap-3">
            <button
              onClick={() => setType("mcq")}
              className={`flex-1 py-2 rounded-xl text-sm font-medium transition ${
                type === "mcq" ? "bg-purple-600 text-white" : "bg-gray-700 text-gray-400 hover:bg-gray-600"
              }`}
            >
              📝 MCQ
            </button>
            <button
              ...
              className={`flex-1 py-2 rounded-xl text-sm font-medium transition ${
                type === "short" ? "bg-purple-600 text-white" : "bg-gray-700 text-gray-400 hover:bg-gray-600"
              }`}
            >
              ✍️ Short Answer
            </button>
              ...
              <div key={i} className="bg-[#40414f] rounded-2xl p-5">
                ...
                <div className="space-y-2">
                  {q.options.map((opt, idx) => (
                    <div key={idx} className="bg-gray-700 rounded-lg px-3 py-2 text-sm text-gray-300">
                      {opt}
                    </div>
                  ))}
                </div>
